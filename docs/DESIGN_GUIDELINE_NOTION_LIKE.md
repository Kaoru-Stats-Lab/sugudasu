---
version: alpha
name: Notion Analysis (reference fork)
description: Notion design language analysis — reference for Schedule Notion-like UX. Do not implement colors verbatim; map via docs/notes/DESIGN_NOTION_SUGUDASU_ADAPT.md. SUGUDASU SSOT remains docs/DESIGN_GUIDELINE.md and assets/sugudasu.css --sg-* tokens.
