...
## 18. uragami（裏紙）— 説明モード — 2026-07-26

| 項目 | 内容 |
|------|------|
| **id** | `uragami` |
| **争点** | 名前付き「説明モード」（画面いっぱい · モード切替） |
| **判定** | **Reject（モード）** · Fit/Zoom・境界強化は合憲 |
| **判例** | [`CASE-2026-008`](../legal/CASE_LAW.md#case-2026-008) |
| **正本** | [`../products/uragami/`](../products/uragami/README.md) |
