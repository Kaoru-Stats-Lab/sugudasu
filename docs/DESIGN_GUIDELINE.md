...
5. **法務・サイトページ**（privacy / terms / hub / updates / statements）= プロダクト接頭辞なし可。`productName` をそのままヘッダーに。**レイアウト・タイポ**: [`DESIGN_GUIDELINE_INFO_PAGES.md`](DESIGN_GUIDELINE_INFO_PAGES.md)
