...
| クローム | `assets/sugudasu-shell.js` | ヘッダー・9本ナビ・フッター。`#sg-chrome-top` の `data-sg-title` 等で **読込時自動マウント**（詳細: `docs/notes/CHROME_HEADER_GUARDRAILS.md`） |
...
```html
<div id="sg-chrome-top" data-sg-title="ツール名" data-sg-print="true"></div>
<!-- main … -->
